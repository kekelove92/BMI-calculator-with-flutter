import 'package:bmi_calculator_app/card/weight_card.dart';
import 'package:bmi_calculator_app/gender_card.dart';
...
Widget _buildCards(BuildContext context) {
  return Padding(
    padding: EdgeInsets.only(
        left: 14, right: 14, top: screenAwareSize(32.0, context)),
    child: Row(
      children: <Widget>[
